...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/react-hangman/releases/download/v1.0.0/react-hangman.zip
SET REPO_NAME=react-hangman.zip
SET EXTRACTED_REPO_DIR=react-hangman
where /q node
IF ERRORLEVEL 1 (
	ECHO==========================================================================
